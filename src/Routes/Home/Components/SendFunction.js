...
const SendFunction = (props) => {
  return (
    <div>
      <h1 className="text-gray-600 text-3xl font-bold ">{props.processing === true ? 'Your file is being processed' : '3. Upload your file'}</h1>
      <div className="mt-5">
        {props.isLoading && <div className="space-y-8 mb-2"> <LinearProgress /></div>}
